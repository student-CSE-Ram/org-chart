  ...
  if (isBarMinimized) {
    return (
      <button
        ...
        className={`absolute bottom-4 left-3 sm:left-6 sm:bottom-6 z-20 px-3 py-1.5 rounded-2xl border shadow-xl backdrop-blur-md text-xs font-bold flex items-center gap-1.5 transition-all hover:scale-105 ${
          isDarkMode
        ...
        title="Show Location Sites Legend"
      >
        <MapPin className="w-3.5 h-3.5 text-rose-500" />
        <span>Sites ({locations.length})</span>
      </button>
    );
  }
      ...
      >
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <button
            ...
            title="Minimize Location Sites Bar"
          >
            <X className="w-3.5 h-3.5" />
          </button>
        </div>
