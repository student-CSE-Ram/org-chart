...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
      ...
      <div key={node.employeeCode} className="flex flex-col text-xs">
        ...
        >
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            {/* Avatar / Crown for CEO / Zap for Shift Incharge */}
  ...
  return (
    <>
      ...
      >
        {/* Sidebar Header */}
        <div className={`p-3 border-b flex flex-col gap-2 ${isDarkMode ? 'border-slate-800' : 'border-slate-200'}`}>
          ...
          <div className="flex items-center justify-between text-[10px] font-semibold gap-1">
            ...
            <span className="px-2 py-0.5 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
              WC: {employees.filter((e) => e.employeeCategory !== 'Blue Collar').length}
            </span>
